...
urlpatterns = [
    ...
    ## ======================== member_list_manage ================================================
    path("entity/<slug:slug>/MembersApp/member_create/", views.member_create, name="member_create"),
    path("entity/<slug:slug>/MembersApp/member_detail/<int:pk>/detail/", views.member_detail, name="member_detail"),
    path("entity/<slug:slug>/MembersApp/member_view/<int:pk>/", views.member_view, name="member_view"),
    path("entity/<slug:slug>/MembersApp/member_edit/<int:pk>/edit/", views.member_edit, name="member_edit"),
    path("entity/<slug:slug>/MembersApp/member_delete/<int:pk>/delete/", views.member_delete, name="member_delete"),
    path("entity/<slug:slug>/MembersApp/member_pdf/<int:pk>/pdf/", views.member_pdf, name="member_pdf"),
    path("entity/<slug:slug>/MembersApp/member_excel/<int:pk>/excel/", views.member_excel, name="member_excel"),
    path("entity/<slug:slug>/MembersApp/member_single_setting/<int:pk>/", views.member_single_setting, name="member_single_setting"),
    ## ===========================PDF Reports======================================================
    path("entity/<slug:slug>/MembersApp/members_info_pdf/", views_mem_reports.members_info_pdf, name="members_info_pdf"),
    path("entity/<slug:slug>/MembersApp/members_contact_pdf/", views_mem_reports.members_contact_pdf, name="members_contact_pdf"),
    path("entity/<slug:slug>/MembersApp/next_of_kin_pdf/", views_mem_reports.next_of_kin_pdf, name="next_of_kin_pdf"),
    path("entity/<slug:slug>/MembersApp/financial_report_pdf/", views_mem_reports.financial_report_pdf, name="financial_report_pdf"),
    ## ==========================Excel Reports=====================================================
    path("entity/<slug:slug>/MembersApp/members_info_excel/", views_mem_reports.members_info_excel, name="members_info_excel"),
    path("entity/<slug:slug>/MembersApp/members_contact_excel/", views_mem_reports.members_contact_excel, name="members_contact_excel"),
    path("entity/<slug:slug>/MembersApp/next_of_kin_excel/", views_mem_reports.next_of_kin_excel, name="next_of_kin_excel"),
    path("entity/<slug:slug>/MembersApp/financial_report_excel/", views_mem_reports.financial_report_excel, name="financial_report_excel"),
    ## ==========================Image Management=================================================
