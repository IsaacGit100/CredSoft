...
urlpatterns = [
    ...
    path("entity/<slug:slug>/trial-balance/excel/", views_reports.trial_balance_excel, name="trial_balance_excel"),
    path("entity/<slug:slug>/income-statement/pdf/", views_reports.income_statement_pdf, name="income_statement_pdf"),
    path("entity/<slug:slug>/income-statement/excel/", views_reports.income_statement_excel, name="income_statement_excel"),
    path("entity/<slug:slug>/balance-sheet/pdf/", views_reports.balance_sheet_pdf, name="balance_sheet_pdf"),
    path("entity/<slug:slug>/balance-sheet/excel/", views_reports.balance_sheet_excel, name="balance_sheet_excel"),    
    path("entity/<slug:slug>/journal-entries/pdf/", views_reports.journal_entries_pdf, name="journal_entries_pdf"),
    path("entity/<slug:slug>/journal-entries/excel/", views_reports.journal_entries_excel, name="journal_entries_excel"),
    path("entity/<slug:slug>/cash-flow/pdf/", views_reports.cash_flow_pdf, name="cash_flow_pdf"),
    
    path("entity/<slug:slug>/cash-flow/excel/", views_reports.cash_flow_excel, name="cash_flow_excel"),
    path("entity/<slug:slug>/settings/", views.entity_settings, name="entity_settings"),
    path("entity/<slug:slug>/account_preferences/", views.account_preferences, name="account_preferences"),
