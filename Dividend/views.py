...
@login_required
def dividend_home(request, slug):
    return render(request,  'Dividend/dividend_home.html')
...
def dividend_appropriation_preview(request, slug):
    ...
    ## =======================================================================
        ...
        if dividend_amount <= 0:
            ...
            return redirect('Dividend:dividend_appropriation_preview', entity.slug)
        ...
        return render(request, 'Dividend/dividend_appropriation.html', context)
...
def dividend_appropriation_execute(request):
    ...
    return render(request, 'Dividend/dividend_appropriation_confirmation.html', context)
...
@login_required
@staff_member_required
def dividend_appropriation_pdf(request, slug):
    ...
    pdf = render_to_pdf('Dividend/dividend_appropriation_pdf.html', context)
    if pdf is None:
...
@login_required
@staff_member_required
def dividend_appropriation_excel(request, slug):
