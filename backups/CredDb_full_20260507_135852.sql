...
CREATE TABLE `accounting_journalentry` (
  ...
  CONSTRAINT `accounting_journalen_transaction_id_43f34c5b_fk_accountin` FOREIGN KEY (`transaction_id`) REFERENCES `accounting_transaction` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `accounting_journalline` (
  ...
  PRIMARY KEY (`id`),
  KEY `accounting_journalli_account_id_2355bfed_fk_accountin` (`account_id`),
  KEY `accounting_journalli_journal_id_9bc2a5f9_fk_accountin` (`journal_id`),
  CONSTRAINT `accounting_journalli_account_id_2355bfed_fk_accountin` FOREIGN KEY (`account_id`) REFERENCES `accounting_account` (`id`),
  CONSTRAINT `accounting_journalli_journal_id_9bc2a5f9_fk_accountin` FOREIGN KEY (`journal_id`) REFERENCES `accounting_journalentry` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `accounting_ledger` (
  ...
  PRIMARY KEY (`id`),
  KEY `accounting_ledger_account_id_01cb8ced_fk_accounting_account_id` (`account_id`),
  KEY `accounting_ledger_journal_line_id_06c581d7_fk_accountin` (`journal_line_id`),
  CONSTRAINT `accounting_ledger_account_id_01cb8ced_fk_accounting_account_id` FOREIGN KEY (`account_id`) REFERENCES `accounting_account` (`id`),
  CONSTRAINT `accounting_ledger_journal_line_id_06c581d7_fk_accountin` FOREIGN KEY (`journal_line_id`) REFERENCES `accounting_journalline` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `accounting_transaction` WRITE;
/*!40000 ALTER TABLE `accounting_transaction` DISABLE KEYS */;
INSERT INTO `accounting_transaction` VALUES (1,'TXN-20260401-0001','2026-04-01','RECEIPT','CASH',2000.00,'Testing1 ','POSTED','2026-04-01 18:11:35.597319');
/*!40000 ALTER TABLE `accounting_transaction` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `coa_accountvisibilitypreference` (
  ...
  CONSTRAINT `coa_accountvisibilit_account_id_877704a4_fk_coa_chart` FOREIGN KEY (`account_id`) REFERENCES `coa_chartofaccounts` (`id`),
...
CREATE TABLE `financeapp_generalledger` (
  ...
  CONSTRAINT `FinanceApp_generalle_account_id_eb213bee_fk_coa_chart` FOREIGN KEY (`account_id`) REFERENCES `coa_chartofaccounts` (`id`),
...
CREATE TABLE `financeapp_journalline` (
  ...
  CONSTRAINT `FinanceApp_journalli_account_id_e321e874_fk_coa_chart` FOREIGN KEY (`account_id`) REFERENCES `coa_chartofaccounts` (`id`),
...
--
-- Table structure for table `loanapp_loanschedule`
--

DROP TABLE IF EXISTS `loanapp_loanschedule`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `loanapp_loanschedule` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  ...
  `loan_id` bigint NOT NULL,
  PRIMARY KEY (`id`),
  KEY `LoanApp_loanschedule_loan_id_078aad4b_fk_LoanApp_loan_id` (`loan_id`),
  CONSTRAINT `LoanApp_loanschedule_loan_id_078aad4b_fk_LoanApp_loan_id` FOREIGN KEY (`loan_id`) REFERENCES `loanapp_loan` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `loanapp_loanschedule`
--

LOCK TABLES `loanapp_loanschedule` WRITE;
/*!40000 ALTER TABLE `loanapp_loanschedule` DISABLE KEYS */;
/*!40000 ALTER TABLE `loanapp_loanschedule` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `loanapp_loantransaction` (
  ...
  CONSTRAINT `LoanApp_loantransaction_created_by_id_19a0c934_fk_auth_user_id` FOREIGN KEY (`created_by_id`) REFERENCES `auth_user` (`id`),
  CONSTRAINT `LoanApp_loantransaction_loan_id_9f57fce1_fk_LoanApp_loan_id` FOREIGN KEY (`loan_id`) REFERENCES `loanapp_loan` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `loginapp_adminloginhistory` (
  ...
  CONSTRAINT `LoginApp_adminloginhistory_user_id_8158c3d8_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `loginapp_memberloginhistory` (
  ...
  CONSTRAINT `LoginApp_memberlogin_member_id_9f5fde8f_fk_MembersAp` FOREIGN KEY (`member_id`) REFERENCES `membersapp_master` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `membersapp_master` (
  ...
  CONSTRAINT `MembersApp_master_approved_by_chairman_45d1c0da_fk_MembersAp` FOREIGN KEY (`approved_by_chairman_id`) REFERENCES `membersapp_master` (`id`),
  CONSTRAINT `MembersApp_master_approved_by_manager__e64608ba_fk_MembersAp` FOREIGN KEY (`approved_by_manager_id`) REFERENCES `membersapp_master` (`id`),
  CONSTRAINT `MembersApp_master_del_user_id_d1d8e269_fk_auth_user_id` FOREIGN KEY (`del_user_id`) REFERENCES `auth_user` (`id`),
  CONSTRAINT `MembersApp_master_is_deleted_user_id_f2b5a1c3_fk_auth_user_id` FOREIGN KEY (`is_deleted_user_id`) REFERENCES `auth_user` (`id`),
  CONSTRAINT `MembersApp_master_loan_int_rate_user_id_8770edd2_fk_auth_user_id` FOREIGN KEY (`loan_int_rate_user_id`) REFERENCES `auth_user` (`id`),
  CONSTRAINT `MembersApp_master_sav_defer_int_appl_u_4329193d_fk_auth_user` FOREIGN KEY (`sav_defer_int_appl_user_id`) REFERENCES `auth_user` (`id`),
  CONSTRAINT `MembersApp_master_sav_int_rate_user_id_337eb519_fk_auth_user_id` FOREIGN KEY (`sav_int_rate_user_id`) REFERENCES `auth_user` (`id`)
...
CREATE TABLE `recpayapp_trans` (
  ...
  CONSTRAINT `RecPayApp_trans_created_by_id_44a4815d_fk_auth_user_id` FOREIGN KEY (`created_by_id`) REFERENCES `auth_user` (`id`),
  CONSTRAINT `RecPayApp_trans_loan_id_1c86f5d9_fk_LoanApp_loan_id` FOREIGN KEY (`loan_id`) REFERENCES `loanapp_loan` (`id`),
  CONSTRAINT `RecPayApp_trans_member_id_1f15a670_fk_MembersApp_master_id` FOREIGN KEY (`member_id`) REFERENCES `membersapp_master` (`id`),
  CONSTRAINT `RecPayApp_trans_updated_by_id_051c7938_fk_auth_user_id` FOREIGN KEY (`updated_by_id`) REFERENCES `auth_user` (`id`)
...
CREATE TABLE `services_statetrans` (
  ...
  CONSTRAINT `services_statetrans_created_by_id_db1b3989_fk_auth_user_id` FOREIGN KEY (`created_by_id`) REFERENCES `auth_user` (`id`),
  CONSTRAINT `services_statetrans_loan_id_36f95c38_fk_LoanApp_loan_id` FOREIGN KEY (`loan_id`) REFERENCES `loanapp_loan` (`id`),
  CONSTRAINT `services_statetrans_master_id_369e1592_fk_MembersApp_master_id` FOREIGN KEY (`master_id`) REFERENCES `membersapp_master` (`id`),
  CONSTRAINT `services_statetrans_updated_by_id_f1510a5f_fk_auth_user_id` FOREIGN KEY (`updated_by_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `services_stateupdate` (
  ...
  CONSTRAINT `services_stateupdate_created_by_id_d6206d48_fk_auth_user_id` FOREIGN KEY (`created_by_id`) REFERENCES `auth_user` (`id`),
  CONSTRAINT `services_stateupdate_updated_by_id_e636c672_fk_auth_user_id` FOREIGN KEY (`updated_by_id`) REFERENCES `auth_user` (`id`)
...
CREATE TABLE `syssetup_auditlog` (
  ...
  CONSTRAINT `SysSetup_auditlog_user_id_b420ba96_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `syssetup_fiscalperiod` (
  ...
  CONSTRAINT `SysSetup_fiscalperiod_closed_by_id_e8adfb11_fk_auth_user_id` FOREIGN KEY (`closed_by_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `syssetup_systempreference` (
  ...
  CONSTRAINT `SysSetup_systempreference_user_id_2a11d7d0_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `syssetup_systemsettings` (
  ...
  CONSTRAINT `SysSetup_systemsettings_updated_by_id_0ddd206a_fk_auth_user_id` FOREIGN KEY (`updated_by_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `userauth_userprofile` (
  ...
  CONSTRAINT `UserAuth_userprofile_user_id_bff39751_fk_auth_user_id` FOREIGN KEY (`user_id`) REFERENCES `auth_user` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `userauth_userprofile` VALUES (1,'','','VIEWER',NULL,NULL,0,0,'light',50,'2026-03-28 04:23:34.005935','2026-05-07 12:48:09.586289',1),(2,'','','VIEWER',NULL,NULL,0,0,'light',50,'2026-04-02 00:22:53.577450','2026-04-02 17:05:10.234632',2);
...
-- Dump completed on 2026-05-07  5:58:52
