...
class MasterForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            "id_card_front": forms.ClearableFileInput(
                attrs={"class": "form-control", "accept": "image/*"}
            ),
            "id_card_back": forms.ClearableFileInput(
                attrs={"class": "form-control", "accept": "image/*"}
            ),
        }
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields["date_of_birth"].input_formats = [
            "%d/%m/%Y",
            "%d-%m-%Y",
            "%Y-%m-%d",
        ]
        self.fields["date_enrolled"].input_formats = [
            "%d/%m/%Y",
            "%d-%m-%Y",
            "%Y-%m-%d",
        ]
...
class MemberSettingsForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            "sav_int_rate": forms.NumberInput(
                attrs={
                    "class": "form-control",
                    "step": "0.0001",
            ...
            "sav_defer_int_appl": forms.CheckboxInput(
                attrs={"class": "form-check-input"}
            ),
            "loan_int_rate": forms.NumberInput(
                attrs={
                    "class": "form-control",
                    "step": "0.0001",
